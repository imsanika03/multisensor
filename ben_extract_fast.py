...
Usage:
  ...
  cat data/ben/S2.tar.gzaa data/ben/S2.tar.gzab | pigz -d | python ben_extract_fast.py --list data/ben/standard_extract_list.txt
"""
import sys
import os
import tarfile
...
list_path = "data/ben/extract_list.txt"
if "--list" in sys.argv:
    list_path = sys.argv[sys.argv.index("--list") + 1]

wanted = set(l.strip() for l in open(list_path))
